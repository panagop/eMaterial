...
## Δικτυακή χρήση μέσω του **colab** της **google**

- Απαιταίται λογαριασμός χρήστη στη google (αρκεί δηλ. να έχετε gmail)
- Ανοίγετε σε κάποιον browser την ιστοσελίδα του [colab](https://colab.research.google.com/)
...
- Δεξιά στην οθόνη θα πρέπει το πεδίο `connected` να είναι επιλεγμένο. Αν όχι, επιλέγετε `connect to hosted runtime`
